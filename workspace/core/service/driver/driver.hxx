...
#pragma section(".text")
    ...
    class c_driver {
        ...
        NTSTATUS send_cmd(
            ...
            if ( m_driver_handle == INVALID_HANDLE_VALUE ) {
                logging::print( "Failed to open driver device" );
    ...
    public:
        ...
        bool initialize( ) {
            ...
            logging::print( "Driver device opened" );
            return true;
        }
        ...
        HANDLE get_handle( ) const { return m_driver_handle; }
        ...
        bool write_physical_memory( uint64_t pa, const void* buffer, size_t size ) {
            ...
            while ( offset < size ) {
                ...
                void* view = map_physical_memory( page_base, 0x1000 );
                if ( !view ) {
                    logging::print( "Failed to map physical page at 0x%llx (offset 0x%llx)", pa, offset );
                    return false;
                }
